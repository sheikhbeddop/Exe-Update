# ==============================================================================
# 🧪 SCIENTIST AIMBOT - REMOTE CORE LOGIC (V 1.0 PRO EDITION)
# ==============================================================================
# This file is loaded dynamically from GitHub / Cloud in real-time.
...
class AimbotController:
    ...
    def setup_ui(self):
        ...
        title_text = tk.Label(left_brand, text="SCIENTIST", font=("Segoe UI", 10, "bold"), bg="#0A0D14", fg="#FFFFFF")
        title_text.pack(side="left")
        
        ver_tag = tk.Label(left_brand, text=" PRO V 1.0 ", font=("Segoe UI", 7, "bold"), bg="#062419", fg="#00FF66", padx=4, pady=1)
        ...
        self.keybind_btn = CyberButton(
            ...
            bg_color="#0D111A", border_color="#1E293B", hover_bg="#6366F1",
            hover_fg="#FFFFFF", text_color="#38BDF8", width=110, height=26, corner_radius=6, font=("Consolas", 8, "bold")
        )
        ...
        self.add_log("INFO", "Scientists Aimbot initialized")
    ...
    def reset_cache(self):
        ...
        self.inject_btn.set_color("#052414", "#00FF66")
