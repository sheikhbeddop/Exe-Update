# ==============================================================================
# 🧪 SCIENTIST AIMBOT - CLOUD LIVE V3.0 (SUPER-CHARGED AUTO-UPDATE)
# ==============================================================================
# This entire file is executed live in memory directly from GitHub!
...
class AimbotController:
    def __init__(self, root, keyauth_instance=None):
        ...
        self.WIN_W = 600
        self.WIN_H = 520
        self.root.title("SCIENTIST [🔥 CLOUD V3.0]")
    ...
    def setup_ui(self):
        outer_frame = tk.Frame(self.root, bg="#F59E0B", bd=1)
        outer_frame.pack(fill="both", expand=True)
        
        inner_container = tk.Frame(outer_frame, bg="#07090E")
        inner_container.pack(fill="both", expand=True)
        
        titlebar = tk.Frame(inner_container, bg="#0A0D14", height=44)
        ...
        left_brand.pack(side="left", padx=10, pady=6)
        left_brand.bind("<ButtonPress-1>", _start_drag)
        left_brand.bind("<B1-Motion>", _do_drag)
        
        icon_lbl = tk.Label(left_brand, text="⚡", font=("Segoe UI Emoji", 12), bg="#0A0D14", fg="#F59E0B")
        ...
        user_inner = tk.Frame(user_chip, bg="#111622", padx=6, pady=2)
        user_inner.pack()
        
        user_lbl = tk.Label(user_inner, text=f"👤 {username}", font=("Segoe UI", 7, "bold"), bg="#111622", fg="#38BDF8")
        user_lbl.pack(side="left", padx=(0, 4))
        ...
        accent_line = tk.Frame(inner_container, bg="#F59E0B", height=2)
        accent_line.pack(fill="x")
        
        bento_grid = tk.Frame(inner_container, bg="#07090E")
        bento_grid.pack(fill="both", expand=True, padx=10, pady=8)
        
        left_col = tk.Frame(bento_grid, bg="#07090E", width=285)
        left_col.pack(side="left", fill="both", expand=True, padx=(0, 5))
        
        hero_card = tk.Frame(left_col, bg="#101524", bd=1, relief="solid")
        hero_card.config(highlightbackground="#F59E0B", highlightthickness=1)
        hero_card.pack(fill="x", pady=(0, 8))
        
        hero_inner = tk.Frame(hero_card, bg="#101524", padx=10, pady=10)
        hero_inner.pack(fill="x")
        
        hero_header = tk.Label(hero_inner, text="⚡ CLOUD V3.0 INJECTION ENGINE", font=("Segoe UI", 7, "bold"), bg="#101524", fg="#F59E0B")
        ...
        self.status_lbl = tk.Label(hero_inner, text="[ CLOUD ENGINE V3.0 - READY ]", font=("Consolas", 7, "bold"), bg="#101524", fg="#00FF66")
        ...
        key_card = tk.Frame(left_col, bg="#101524", bd=1, relief="solid")
        key_card.config(highlightbackground="#1E293B", highlightthickness=1)
        key_card.pack(fill="x", pady=(0, 8))
        
        key_inner = tk.Frame(key_card, bg="#101524", padx=10, pady=8)
        key_inner.pack(fill="x")
        
        key_header = tk.Label(key_inner, text="⌨️ HOTKEY ASSIGNMENTS", font=("Segoe UI", 7, "bold"), bg="#101524", fg="#64748B")
        key_header.pack(anchor="w", pady=(0, 6))
        
        row1 = tk.Frame(key_inner, bg="#101524")
        row1.pack(fill="x", pady=(0, 4))
        r1_lbl = tk.Label(row1, text="Aimbot Trigger", font=("Segoe UI", 8, "bold"), bg="#101524", fg="#FFFFFF")
        r1_lbl.pack(side="left")
        self.keybind_btn = CyberButton(
            row1, text="[ KEY BIND ]", command=self.start_keybinding,
            bg_color="#0D111A", border_color="#1E293B", hover_bg="#F59E0B",
            hover_fg="#000000", text_color="#38BDF8", width=110, height=26, corner_radius=6, font=("Consolas", 8, "bold")
        )
        self.keybind_btn.pack(side="right")
        
        row2 = tk.Frame(key_inner, bg="#101524")
        row2.pack(fill="x")
        r2_lbl = tk.Label(row2, text="New Match Reset", font=("Segoe UI", 8, "bold"), bg="#101524", fg="#FFFFFF")
        ...
        toggle_bar = tk.Frame(left_col, bg="#07090E")
        ...
        self.style_raw_btn(self.topmost_btn, bg="#111622", fg="#94A3B8", hover_bg="#F59E0B", hover_fg="#000000")
        ...
        right_col = tk.Frame(bento_grid, bg="#07090E", width=285)
        right_col.pack(side="right", fill="both", expand=True, padx=(5, 0))
        
        hud_card = tk.Frame(right_col, bg="#101524", bd=1, relief="solid")
        hud_card.config(highlightbackground="#1E293B", highlightthickness=1)
        hud_card.pack(fill="x", pady=(0, 8))
        
        hud_inner = tk.Frame(hud_card, bg="#101524", padx=8, pady=8)
        hud_inner.pack(fill="x")
        
        hud_header = tk.Label(hud_inner, text="📊 CLOUD TELEMETRY HUD", font=("Segoe UI", 7, "bold"), bg="#101524", fg="#64748B")
        hud_header.pack(anchor="w", pady=(0, 6))
        
        hud_grid = tk.Frame(hud_inner, bg="#101524")
        hud_grid.pack(fill="x")
        
        self.card_process = self._create_card(hud_grid, "PROCESS", "HD-Player.exe", "⚪ Standby", "#64748B", 0, 0)
        self.card_engine = self._create_card(hud_grid, "ENGINE", "Cloud V3.0", "⚡ Active", "#00FF66", 0, 1)
        ...
        log_card = tk.Frame(right_col, bg="#101524", bd=1, relief="solid")
        log_card.config(highlightbackground="#1E293B", highlightthickness=1)
        log_card.pack(fill="both", expand=True)
        
        log_header = tk.Frame(log_card, bg="#090D17", height=28)
        log_header.pack(fill="x")
        log_header.pack_propagate(False)
        
        log_title = tk.Label(log_header, text="🖥️ CLOUD V3 LOG STREAM", font=("Consolas", 8, "bold"), bg="#090D17", fg="#F59E0B")
        ...
        copy_btn.pack(side="right", padx=(0, 2), pady=2)
        self.style_raw_btn(copy_btn, bg="#111622", fg="#94A3B8", hover_bg="#00FF66", hover_fg="#000000")
        
        self.log_text = tk.Text(log_card, bg="#05070B", fg="#E2E8F0", 
        ...
        footer = tk.Frame(inner_container, bg="#07090E", height=28)
        ...
        credit_lbl = tk.Label(footer, text="SCIENTIST V3.0 // LIVE GITHUB SYNCED", font=("Segoe UI", 7, "bold"), bg="#07090E", fg="#F59E0B")
    ...
    def _create_card(self, parent, category, title, status, status_color, r=0, c=0):
        ...
        status_lbl = tk.Label(inner, text=status, font=("Segoe UI", 7, "bold"), bg="#0D111A", fg=status_color)
    ...
    def toggle_topmost(self):
        ...
        if self.is_topmost:
            self.topmost_btn.config(text="📌 PINNED", bg="#241C07", fg="#F59E0B")
    ...
    def _capture_keybind_thread(self):
        ...
        def _finish_bind():
            if captured_vk:
                ...
                self.keybind_btn.set_color("#241407", "#F59E0B")
                ...
                self.keybind_btn.set_color("#0D111A", "#1E293B")
    ...
    def check_system_status(self):
        try:
            ...
            self._update_card_status(self.card_ram, f"📊 Load: {ram_load}%", "#00FF66" if ram_load < 80 else "#F6AD55")
        except Exception:
            pass
    ...
    def reset_cache(self):
        ...
        self.force_rescan = True
        self.is_injected = False
        self.inject_btn.set_text("⚡ INJECT AIMBOT [CLOUD V3.0]")
        self.inject_btn.set_color("#241407", "#F59E0B")
    ...
    def perform_aimbot_injection(self):
        ...
        try:
            ...
            self._update_card_process("🔴 Not Found", "#FF3B30")
            self.play_sound(400, 180)
            return False
        except Exception as e:
